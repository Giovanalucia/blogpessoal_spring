...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/Giovanalucia/blogpessoal_spring) dentro da pasta do *Workspace* do STS
 
```bash
git clone https://github.com/Giovanalucia/blogpessoal_spring.git
```
...
Desenvolvido por [**Giovana Lucia**](https://github.com/Giovanalucia)
